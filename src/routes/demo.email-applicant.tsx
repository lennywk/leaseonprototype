...
export const Route = createFileRoute("/demo/email-applicant")({
  head: () => ({
    meta: [
      { title: "Demo · Applicant Email — GGP LeaseOn" },
      { name: "description", content: "Preview of the pricing email sent to the applicant after review." },
    ],
  }),
  component: DemoEmailApplicant,
});
          ...
          <div className="bg-card border border-border rounded-lg overflow-hidden shadow-sm">
            ...
            <div className="p-6 space-y-5 text-sm font-body">
              ...
              <div className="space-y-2">
                ...
                <InfoRow label="Lease term" value={termLine} />
              </div>
